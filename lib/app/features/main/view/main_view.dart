              ...
              children: [
                ...
                Container(
                  ...
                  child: IntlPhoneField(
                    ...
                    style:
                        isDarkMode ? Style.whiteGothamLigh : Style.gothamLight,
                    dropdownTextStyle:
                        isDarkMode ? Style.whiteGothamLigh : Style.gothamLight,
                    decoration: const InputDecoration(
                      border: InputBorder.none,
                ...
                Text(
                  AppLocalizations.of(context)!.confirmerLeNumeroDeTelephone,
                  style:
                      isDarkMode ? Style.whiteGothamMedium : Style.gothamMedium,
                ),
                SizedBox(height: 12.h),
                Container(
                  padding: EdgeInsets.symmetric(
                    ...
                    onPressed: () async{
                      ...
                      if (!_formKey.currentState!.validate()) {
                       ...
                       if(await database.state.createForm(model)){
                        Fluttertoast.showToast(msg: "effectuer");
                       }
                       else{
