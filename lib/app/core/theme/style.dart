...
class Style {
  static TextStyle gotham = TextStyle(
    fontFamily: "Gotham",
  );

  static TextStyle gothamMedium = gotham.copyWith(
      fontWeight: FontWeight.w400, color: Palette.black, fontSize: 39.96.sp);
  static TextStyle primaryGothamMedium = gotham.copyWith(
      fontWeight: FontWeight.w400, color: Palette.primary, fontSize: 39.96.sp);
